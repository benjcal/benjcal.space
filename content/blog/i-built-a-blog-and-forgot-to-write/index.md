...
This might be obvious to some people but it wasn't for me until recently: in life there are things I care about the **_process_** and others that I care about the **_results_**, and mixing the two has caused me so much pain.

Two examples, 3D printing and Linux.

I got into 3D printing a few years ago. It was so fun to be able to see things on a screen and then have them as physical objects in the world. I printed so many useful things to organize my office, showcase my mechanical keyboards, hold the keys and paper towel, all kinds of cool things. But then, as a proper tinkerer, I wanted more control over my 3D printer. So I swapped out the main board, flashed a custom firmware, connected a Raspberry Pi to it, added a webcam, tweaked the motors and added some extra sensors... but completely lost my interest in 3D printing...
